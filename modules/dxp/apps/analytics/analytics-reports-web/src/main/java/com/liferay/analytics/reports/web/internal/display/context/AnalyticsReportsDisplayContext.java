...
public class AnalyticsReportsDisplayContext {
	...
	public Map<String, Object> getData() {
		...
		_data = HashMapBuilder.<String, Object>put(
			...
			HashMapBuilder.<String, Object>put(
				"defaultTimeRangeKey", TimeRange.defaultTimeRangeKey()
			).put(
				"endpoints",
				HashMapBuilder.<String, Object>put(
				...
				"timeRanges", _getTimeRangesJSONArray(_themeDisplay.getLocale())
			).build()
		).put(
			"props", getProps()
		).build();
	...
	private JSONArray _getTimeRangesJSONArray(Locale locale) {
		JSONArray timeRangesJSONArray = JSONFactoryUtil.createJSONArray();

		ResourceBundle resourceBundle = ResourceBundleUtil.getBundle(
			"content.Language", locale, getClass());

		Collection<TimeRange> timeRanges = TimeRange.values();

		timeRanges.forEach(
			timeRange -> timeRangesJSONArray.put(
				JSONUtil.put(
					"label",
					LanguageUtil.get(resourceBundle, timeRange.getKey())
				).put(
					"value", timeRange.getKey()
				)));

		return timeRangesJSONArray;
	}
