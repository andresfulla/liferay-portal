...
<%
SegmentsSimulationDisplayContext segmentsSimulationDisplayContext = (SegmentsSimulationDisplayContext)request.getAttribute(SegmentsSimulationKeys.SEGMENTS_SIMULATION_DISPLAY_CONTEXT);
%>
