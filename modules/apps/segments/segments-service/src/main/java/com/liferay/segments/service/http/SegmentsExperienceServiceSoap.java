...
public class SegmentsExperienceServiceSoap {
	public static com.liferay.segments.model.SegmentsExperienceSoap addSegmentsExperience(
		String[] nameMapLanguageIds, String[] nameMapValues, String layoutUuid,
		...
		try {
			...
			com.liferay.segments.model.SegmentsExperience returnValue = SegmentsExperienceServiceUtil.addSegmentsExperience(nameMap,
