...
public class SegmentsExperienceServiceSoap {
	public static com.liferay.segments.model.SegmentsExperienceSoap addSegmentsExperience(
		...
		String[] nameMapLanguageIds, String[] nameMapValues, boolean active,
		int priority,
		...
		try {
			...
			com.liferay.segments.model.SegmentsExperience returnValue = SegmentsExperienceServiceUtil.addSegmentsExperience(classNameId,
					classPK, segmentsEntryId, nameMap, active, priority,
					serviceContext);
