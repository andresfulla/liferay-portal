...
public interface SegmentsExperienceLocalService extends BaseLocalService,
	 ...
	 */
	public SegmentsExperience addSegmentsExperience(long classNameId,
		long classPK, long segmentsEntryId, Map<Locale, String> nameMap,
		boolean active, int priority, ServiceContext serviceContext)
