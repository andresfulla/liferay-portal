...
public interface SegmentsExperiencePersistence
	 ...
	 * @return the matching segments experiences
	 */
	public java.util.List<SegmentsExperience> findByG_C_C_A_A(
		long groupId, long classNameId, long classPK, boolean active,
		boolean approved);
	 ...
	 * @return the matching segments experiences that the user has permission to view
	 */
	public java.util.List<SegmentsExperience> filterFindByG_C_C_A_A(
		long groupId, long classNameId, long classPK, boolean active,
		boolean approved);
	 ...
	 * @return the matching segments experiences
	 */
	public java.util.List<SegmentsExperience> findByG_S_C_C_A_A(
		long groupId, long segmentsEntryId, long classNameId, long classPK,
	 ...
	 * @return the matching segments experiences that the user has permission to view
	 */
	public java.util.List<SegmentsExperience> filterFindByG_S_C_C_A_A(
		long groupId, long segmentsEntryId, long classNameId, long classPK,
		boolean active, boolean approved);
