...
public class SegmentsExperienceServiceWrapper
	...
	public com.liferay.segments.model.SegmentsExperience addSegmentsExperience(
		...
		return _segmentsExperienceService.addSegmentsExperience(classNameId,
	...
	public com.liferay.segments.model.SegmentsExperience deleteSegmentsExperience(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return _segmentsExperienceService.deleteSegmentsExperience(segmentsExperienceId);
	}
	...
	*/
	...
	public com.liferay.segments.model.SegmentsExperience getSegmentsExperience(
		long segmentsExperienceId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _segmentsExperienceService.getSegmentsExperience(segmentsExperienceId);
	}
	...
	public java.util.List<com.liferay.segments.model.SegmentsExperience> getSegmentsExperiences(
		...
		return _segmentsExperienceService.getSegmentsExperiences(groupId,
			classNameId, classPK, active, start, end, orderByComparator);
	}

	@Override
	public int getSegmentsExperiencesCount(long groupId) {
		return _segmentsExperienceService.getSegmentsExperiencesCount(groupId);
	}
	...
	public com.liferay.segments.model.SegmentsExperience updateSegmentsExperience(
		...
		boolean active)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _segmentsExperienceService.updateSegmentsExperience(segmentsExperienceId,
