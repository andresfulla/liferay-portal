...
public class SegmentsExperienceLocalServiceTest {
	...
	@Test
	public void testDeleteSegmentsExperienceWithIntermediatePriority()
		throws Exception {
		...
		_segmentsExperienceLocalService.deleteSegmentsExperience(
			_group.getGroupId(), _classNameId, _classPK, 2);
	...
	public void testMoveSegmentsExperienceToInvalidPosition() throws Exception {
		...
		int currentPriority = segmentsExperience.getPriority();

		SegmentsExperience segmentsExperienceNegativePosition =
			_segmentsExperienceLocalService.moveSegmentsExperience(
				_group.getGroupId(), _classNameId, _classPK, currentPriority,
				-1);
