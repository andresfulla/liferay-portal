 ...
 * @review
 */
function addSectionReducer(state, payload) {
	let nextState = state;
 ...
 * @review
 */
function moveSectionReducer(state, payload) {
	let nextState = state;
 ...
 * @review
 */
function removeSectionReducer(state, payload) {
	let nextState = state;
 ...
 * @return {object}
 */
const updateSectionConfigReducer = (state, payload) => new Promise(
	resolve => {
		let nextState = state;
